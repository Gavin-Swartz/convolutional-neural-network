...
class CNN(nn.Module):
  def __init__(self, num_classes):
    super().__init__()
    self.conv1 = nn.Conv2d(1, 32, 3)        # Create 2D convolutional layer given a single input channel. 32 filters and 3x3 kernel.
    self.pool = nn.MaxPool2d(2, 2)          # Max pooling layer with 2x2 kernel size and stride of 2.
    self.conv2 = nn.Conv2d(32, 64, 3)       # Use output channels of conv1 (32) to create 64 feature maps using 3x3 kernel.
    self.fc1 = nn.Linear(64 * 3 * 3, 120)   # Fully connected layer with 64 feature maps * kernel (3x3) to get output of 120 neurons.
